  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium hidden", // caption label hiiden
        ...
        caption_dropdowns: "flex gap-1", //dropdowns side by side
        ...classNames,
      }}
      components={{
        ...
        Dropdown: (props) => {
          ...
          console.log(fromDate, fromMonth, fromYear, toDate, toMonth, toYear);
          
          const {goToMonth, currentMonth} = useNavigation(); //currentMonth contains both the month and year
